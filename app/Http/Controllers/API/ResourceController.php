 ...
 * 
 * @OA\Info(
 *     title="Resource Booking API", version="1.0.0", description="API documentation for Resource Booking System",
...
class ResourceController extends Controller
{
     ...
     * 
     * @OA\Post(
     *     path="/api/resources", operationId="createResource",
     *     tags={"Resources"}, summary="Создание ресурса", description="Создает новый ресурс",
     *     @OA\RequestBody(
     *         required=true,
     ...
     *         )
     *     ),
     *     @OA\Response(response=201, description="Ресурс создан успешно",@OA\JsonContent(ref="#/components/schemas/Resource")),
     ...
     * 
     * @OA\Get(
     *     path="/api/resources", operationId="getResourcesList",
     *     tags={"Resources"}, summary="Получение списка ресурсов",
     *     description="Возвращает список всех ресурсов",
     *     @OA\Response(response=200, description="Успешная операция", @OA\JsonContent(type="array", @OA\Items(ref="#/components/schemas/Resource")))
     * )
     ...
     *     @OA\Parameter(name="id", in="path", description="ID ресурса", required=true, @OA\Schema(type="integer")),
     *     @OA\Response( response=200, description="Успешная операция", @OA\JsonContent(type="array", @OA\Items(ref="#/components/schemas/Booking"))),
